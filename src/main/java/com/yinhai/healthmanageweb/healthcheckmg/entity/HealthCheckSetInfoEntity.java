package com.yinhai.healthmanageweb.healthcheckmg.entity;

import java.io.Serializable;
import java.util.Date;

public class HealthCheckSetInfoEntity implements Serializable {
    private static final long serialVersionUID = 531648937019024918L;
    //套餐流水号
